...
import { StyleSheet,Alert,Button, Text, ScrollView, View, TextInput, Image,Modal,ActivityIndicator,TouchableOpacity } from 'react-native';
...
export default class tambahKat extends React.Component {
    constructor(props){
        super(props);
        this.state={
            avatarSource:null,
    ...
    uploadGambar=()=>{
        ...
        const url2="https://adi0711.000webhostapp.com/api/tambahKategori.php"
        fetch(url2, {
          method:'post',
          headers: {
        ...
        .then((responseJson) =>
        {
            ...
            this.props.navigation.navigate("pilihTambah");
    ...
    return (
            ...
            <ScrollView contentContainerStyle={{flexGrow : 1, justifyContent: 'space-between'}}>
                ...
                >
                    ...
                    <TouchableOpacity style={styles.buttonku} onPress={this.uploadGambar}>
                    <Text style={{color:'white'}}>Simpan Data</Text>
                   </TouchableOpacity>
                </View>
